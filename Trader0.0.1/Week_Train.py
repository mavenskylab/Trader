...
SAVE_PATH = "saved_model/week_model"
...
def create_model():
    with strategy.scope():
        model = tf.keras.Sequential([
            tf.keras.layers.InputLayer(input_shape=(32, 4)),
...
sequential_data = read("week_data")
...
checkpoint_dir = "./week_checkpoints"
checkpoint_prefix = os.path.join(checkpoint_dir, "ckpt_{epoch}")

callbacks = [
    tf.keras.callbacks.TensorBoard(log_dir="./week_logs"),
